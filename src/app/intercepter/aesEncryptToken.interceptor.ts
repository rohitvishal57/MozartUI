...
export class EncryptionInterceptor implements HttpInterceptor {
  ...
  private excludedUrls: string[] = [
    ...
    'https://usp.monocept.ai/api/rug/getAllDisposition?appName=TELESALES',
    'https://upuat.adityabirlahealth.com/api/rug/GetAllSubDisposition',
    'https://usp.monocept.ai/api/rug/GetAllSubDisposition',
    'https://usp.monocept.ai/api/rug/GetPincodeDetails',
    'https://upuat.adityabirlahealth.com/api/rug/GetLeads',
    'https://usp.monocept.ai/api/rug/GetAllBaseCallers',
    'https://usp.monocept.ai/api/rug/GetMasterDetails',
    'https://usp.monocept.ai/api/rug/GetLeads',
    'https://upuat.adityabirlahealth.com/api/rug/GetMasterDetails',
    ...
    'https://upuat.adityabirlahealth.com/api/rug/AssignBackToDo',
    'https://upuat.adityabirlahealth.com/api/rug/GetAllAudit',
    ...
    "https://usp.monocept.ai/api/rug/CreateManageLob",
    "https://upuat.adityabirlahealth.com/api/rug/GetAllBaseCallers?pageNo=1&noOfRow=100",
    "https://upuat.adityabirlahealth.com/api/rug/ExtractMasterData"
  ];
